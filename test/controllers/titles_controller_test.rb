...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { emp_no: @title.emp_no, from_date: @title.from_date, title: @title.title, to_date: @title.to_date }
    end
  ...
  test "should update title" do
    patch :update, id: @title, title: { emp_no: @title.emp_no, from_date: @title.from_date, title: @title.title, to_date: @title.to_date }
    assert_redirected_to title_path(assigns(:title))
  end
